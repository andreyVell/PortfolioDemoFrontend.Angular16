...
@Component({
  selector: 'app-client-small-project-card',
  templateUrl: './client-small-project-card.component.html',
  styleUrls: ['./client-small-project-card.component.css']
})
export class ClientSmallProjectCardComponent {
